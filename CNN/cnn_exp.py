...
def run_exp(repeats=3):
    ...
    for tag in tags:
        ...
        accel_input_df, groundtruth_df = load_to_df(accel_filepaths, groundtruth_path, standardized_delta=1)
        uwb_input_df, _ = load_to_df(uwb_filepaths, groundtruth_path, standardized_delta=1)
